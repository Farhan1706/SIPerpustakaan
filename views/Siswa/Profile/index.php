...
<head>
  ...
  <?php
    ...
    $sql_cek = "SELECT * FROM akun WHERE email='".$email."'";
                  ...
                  <div class="template-demo">
                    <nav aria-label="breadcrumb">
                      <ol class="breadcrumb breadcrumb-custom bg-primary">
                        <li class="breadcrumb-item"><a style="color: black; font-weight:bold; text-decoration: none;">Settings</a></li>
                        <li class="breadcrumb-item active" aria-current="page"><span>Edit Akun</span></li>
                      </ol>
                    </nav>
                  </div>
                </div>
                ...
                <div class="card-body">
                  <form class="forms-sample" action="" method="POST">
                            ...
                            <div class="form-group input-group">
                              ...
                              <input type="text" class="form-control" id="rfid" name="rfid" value="<?php echo $data_check['rfid']; ?>" disabled>
                            </div>
                    ...
                    <a class="btn btn-light" href="/sipus/views/Siswa/Dashboard">Batal</a>
                  </form>
                </div>
                </div>
            </div>
