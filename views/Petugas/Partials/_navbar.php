          ...
          <ul class="navbar-nav navbar-nav-right">
            ...
            <li class="nav-item dropdown mr-1">
              <a class="nav-link count-indicator dropdown-toggle d-flex justify-content-center align-items-center" id="messageDropdown" href="#" data-toggle="dropdown">
                ...
                <?php
                $kueri = $koneksi->query("SELECT id_sk FROM data_transaksi WHERE status='PES' GROUP BY id_sk");
                $pesan = $kueri->num_rows;
                if($pesan>0){
                  echo("<span class='count bg-info'>".$pesan."</span>");
                }else{
                  echo("");
                }
                ?>
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
                <p class="mb-0 font-weight-normal float-left dropdown-header">Permintaan Peminjaman</p>
                  ...
                  if($pesan>0){
                    echo("
                    <a class='dropdown-item preview-item' href='/sipus/views/Petugas/Transaksi/req-buku'>
                  ...
                  <div class='preview-item-content'>
                    <h6 class='preview-subject font-weight-normal'>".$pesan." Menunggu Persetujuan</h6>
                  ...
                  <div class='preview-item-content'>
                    <h6 class='preview-subject font-weight-normal'>Tidak Ada Permintaan</h6>
                    <p class='font-weight-light small-text mb-0 text-muted'>
            ...
            <li class="nav-item dropdown mr-2">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
                <p class="mb-0 font-weight-normal float-left dropdown-header">Notifikasi</p>
                  ...
                  if($NSiswa>0){
                    echo("
                    <a class='dropdown-item preview-item' href='/sipus/views/Petugas/PendataanAnggota/Nonsiswa'>
                    <div class='preview-thumbnail'>
          ...
          <ul class="navbar-nav navbar-nav-right">
            <li class="nav-item nav-profile dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
                <a class="dropdown-item" href="/sipus/views/Petugas//Profile">
                  <i class="mdi mdi-settings text-primary"></i>
                  Settings
                </a>
                <a class="dropdown-item" href="/sipus/views/Petugas/destroy.php">
