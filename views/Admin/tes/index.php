...
$connect = new PDO("mysql:host=localhost;dbname=sipus", "root", "");
$message = '';
if(isset($_POST["email"]))
{
 ...
 $query = "
 INSERT INTO akun 
 (id_anggota, email, password, rfid, no_hp, nama, jekel, kelas, status) VALUES 
 (:id_anggota, :email, :password, :rfid, :no_hp, :nama, :jekel, :kelas, :status)
 ";
       ...
       <div class="panel-body">
        ...
        <div class="form-group">
         ...
         <label class="radio-inline">
          <input type="radio" name="jekel" value="LK" checked> Male
         </label>
         <label class="radio-inline">
          <input type="radio" name="jekel" value="PR"> Female
         </label>
        </div>
        <div class="form-group">
         <label>HP</label>
